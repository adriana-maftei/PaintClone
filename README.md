This project is a Paint clone app - a classic Windows application for drawing - made with Visual Studio & C# programmming language. The EXE file is available in the "bin" folder.
